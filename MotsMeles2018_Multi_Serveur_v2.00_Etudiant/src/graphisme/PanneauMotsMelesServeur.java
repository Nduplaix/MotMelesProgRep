...
public class PanneauMotsMelesServeur extends PanneauGrilleCars {
	...
	GestionnaireJeuServeur gestionnaireJeu;
	...
	public PanneauMotsMelesServeur(char[][] carsGrilleMots,String mots[],GestionnaireJeuServeur gestionnaireJeu){
		super(0,Color.BLACK);
	...
	public void termine(){
		...
		addMouseListener(new MouseAdapter(){
	         public void mouseClicked(MouseEvent e) {
	        	 gestionnaireJeu.terminePartie();
	        	 SwingUtilities.windowForComponent(PanneauMotsMelesServeur.this).dispose();
	      }});
	}
