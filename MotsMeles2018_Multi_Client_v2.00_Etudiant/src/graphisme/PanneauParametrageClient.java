...
public class PanneauParametrageClient extends PanneauGrilleCars {

	
	public static final ImageRessource imageLogo=new ImageRessource("/graphisme/cassouletDeMotsClient.png");
	...
	public PanneauParametrageClient(String question,char[] saisie){
		super(0,Color.BLACK);
		this.saisie=saisie;
		saisieS="";
	...
	private void initialiseGestionnaireSouris(){
		addMouseListener(new MouseAdapter(){
	         public void mouseClicked(MouseEvent e) {
	        	SwingUtilities.windowForComponent(PanneauParametrageClient.this).dispose();
	         }                
	      });	
	}
	private void initialiseGestionnaireClavier(){
		addKeyListener(new KeyAdapter(){
			  public void keyPressed(KeyEvent e) { 
				  if ((e.getKeyChar()=='.')||(e.getKeyChar()==':')||(e.getKeyChar()==' ')||((e.getKeyChar()>='a')&&(e.getKeyChar()<='z'))||((e.getKeyChar()>='A')&&(e.getKeyChar()<='Z')||((e.getKeyChar()>='0')&&(e.getKeyChar()<='9'))))
...
public static void main(String[] args) {
	...
	PanneauParametrageClient panneauParametrage=new PanneauParametrageClient("VOTRE PSEUDO",new char[16]);
